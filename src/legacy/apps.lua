...
local DEFINITIONS = {
  ...
  },
  {
    id = "devices",
    name = "Devices",
    program = "legacy/apps/devices.lua",
    args = { "--embedded" },
    kinds = { "computer", "pocket", "command" },
    roles = { "fleet", "controller" },
    surfaces = { "desktop", "handheld" },
  ...
  },
  {
    id = "automation",
    name = "Auto Recovery",
    program = "legacy/apps/automation.lua",
    kinds = { "computer", "pocket", "command" },
    roles = { "fleet", "controller" },
    surfaces = { "desktop", "handheld" },
    requiresInput = true,
  },
  {
    id = "operations",
    name = "Mine Control",
    program = "legacy/apps/operations.lua",
    kinds = { "computer", "pocket", "command" },
    roles = { "fleet", "controller" },
    surfaces = { "desktop", "handheld" },
    requiresInput = true,
  ...
  },
  {
    id = "fleet-console",
    name = "Fleet Console",
    program = "legacy/apps/console.lua",
    kinds = { "computer", "command" },
    roles = { "fleet" },
    surfaces = { "desktop" },
    requiresInput = true,
  ...
  },
  {
    id = "gps-host",
    name = "GPS Host",
    program = "legacy/apps/gps_host.lua",
